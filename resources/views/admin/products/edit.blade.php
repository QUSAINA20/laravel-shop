                    ...
                    <div class="card-body">
                                ...
                                <div class="form-check form-check-radio">
                                    <label class="form-check-label">
                                        <input
                                            ...
                                            {{ $product->getTranslation('status', 'ar') === 'متوفر' ? 'checked' : '' }}>
                                        متوفر
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>
                                <div class="form-check form-check-radio">
                                    <label class="form-check-label">
                                        <input
                                            ...
                                            {{ $product->getTranslation('status', 'ar') == 'غير متوفر' ? 'checked' : '' }}>
                                        غير متوفر
                                        <span class="form-check-sign"></span>
                                    </label>
                                </div>
                        ...
                        <div class="custom-file {{ $errors->has('images') ? ' has-danger' : '' }}">
                            <input class="form-control file{{ $errors->has('images') ? ' is-invalid' : '' }}"
                                ...
                                placeholder="{{ __('Upload Images') }}" value="{{ $product->getMedia('images') }}"
